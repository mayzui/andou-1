            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal m-t-md" action="{{ route('banner.store') }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                        ...
                        <div class="input-group col-sm-2">
                            <select name="banner_position_id" class="form-control form-select">
                                @foreach($position as $key=>$item)
                                    <option value="{{$item->id}}" @if ( $banner->banner_position_id == $item->id) selected @endif >{{$item->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="url" value="{{$banner->url}}" required data-msg-required="请输入跳转链接">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="desc" value="{{$banner->desc}}" required data-msg-required="描述信息">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="sort" value="{{$banner->sort}}" required data-msg-required="排序">
                        </div>
                    </div>
                    <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                    <div class="form-group">

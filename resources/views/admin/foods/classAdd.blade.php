        ...
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                <a href="{{route('foods.classification')}}">
                    <button class="btn btn-primary btn-sm" type="button"><i class="fa fa-plus-circle"></i> 饭店分类</button>
                </a>
                <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                <form class="form-horizontal m-t-md" action="{{route('foods.addClass')}}" method="POST">

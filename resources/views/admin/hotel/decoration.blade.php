...
@section('content')
        ...
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"><em style="margin-right:5px;vertical-align: middle;color: #fe0000;">*</em>设施图片：</label>
                    <div class="col-sm-6 add_div">
                        ...
                        @endif
                      @if(!empty($i))
                                                   <input type="file" name="choose-file[]" id="choose-file" onchange="change()" alt="2323" multiple="multiple"/>
                      @else
    ...
    <script type="text/javascript">
        function change() {
            var obj = document.getElementById("choose-file");

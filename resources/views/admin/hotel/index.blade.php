    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                ...
                <a href="{{route('hotel.add')}}" @if($role==0) style="display:none" @endif link-url="javascript:void(0)">
                    <button class="btn btn-primary btn-sm" type="button"><i class="fa fa-plus-circle"></i> 新增房间</button>
                </a>
                    <style>
                        th ,td{ 
                            text-align: center;
                        ...
                        @foreach($data as $k => $item)
                            <tr>
                                ...
                                <td class="text-center">    
                                    <div class="btn-group">
                                    <a href="{{route('hotel.add')}}?id={{$item->id}}" @if($role==0) style="display:none" @endif><button class="btn btn-primary btn-xs" type="button"><i class="fa fa-paste"></i> 修改</button></a>
                                    @if($item->status==1)

        ...
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                <a href="{{route('hotel.classification')}}">
                    <button class="btn btn-primary btn-sm" type="button"><i class="fa fa-plus-circle"></i> 酒店分类</button>
                </a>
                <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                <form class="form-horizontal m-t-md" action="{{route('hotel.addClass')}}" method="POST">

        ...
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                ...
                {{ csrf_field() }}
                    ...
                    <a href="{{url('/admin/hotel/merchant?status=0')}}" link-url="javascript:void(0)"><button class="btn btn-primary btn-sm" type="button">
                            全部</button>
                    </a>
                    <a href="{{url('/admin/hotel/merchant?status=1')}}" link-url="javascript:void(0)"><button class="btn btn-primary btn-sm" type="button">
                            已审核</button>
                    </a>
                    <a href="{{url('/admin/hotel/merchant?status=2')}}" link-url="javascript:void(0)"><button class="btn btn-primary btn-sm" type="button">
                            未审核</button>
                    </a>
                    <a href="{{url('/admin/hotel/merchant?status=3')}}" link-url="javascript:void(0)"><button class="btn btn-primary btn-sm" type="button">
                            已禁用</button>
                    </a>
                    <a href="{{url('/admin/hotel/merchant?status=4')}}" link-url="javascript:void(0)"><button class="btn btn-primary btn-sm" type="button">
                            已启用</button>
                    </a>
                </form>
                    <style>
    ...
    <script type="text/javascript">
        function del(e) {
            ...
            layer.alert("是否更新状态？",{icon:3},function (index) {
                location.href="{{route('hotel.hotelStatus')}}?id="+id;
                layer.close(index);
            });
        }
    </script>

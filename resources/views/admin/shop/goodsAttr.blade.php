    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                <a href="{{route('shop.addAttr')}}" link-url="javascript:void(0)"><button class="btn btn-primary btn-sm" type="button"><i class="fa fa-plus-circle"></i> 添加属性</button></a>
            ...
            <form class="form-horizontal"  id="saveAttrValue" method="post" action="{{route('shop.saveAttrValue')}}">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="attrName" id="attrName"  class="form-control" value=""/>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">值列表(双击删除) <span class="btn btn-info btn-sm" onclick="addinput()">+</span> </label>

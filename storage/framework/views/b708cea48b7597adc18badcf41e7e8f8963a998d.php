        ...
        <div class="ibox-content">
            ...
            <form class="form-horizontal m-t-md" action="<?php echo e(route('admins.update',$admin->id)); ?>" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-2">
                        <input type="text" class="form-control" name="mobile" value="<?php echo e($admin->mobile); ?>" readonly>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-2">
                        ...
                        <span class="view picview ">
                           <img id="thumbnail-avatar" class="thumbnail img-responsive" src="<?php echo e($admin->avator); ?>" width="100" height="100">
                        </span>
                    </div>
                </div>
                <div class="hr-line-dashed m-t-sm m-b-sm"></div>

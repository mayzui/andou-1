...
Route::group(['namespace' => 'Admin','prefix' => 'admin'], function (){
    ...
    Route::middleware(['auth:admin','rbac'])->group(function (){//LM
        ...
        Route::post('shop/decoration','IndexsController@voice_play')->name('shop.decoration'); // 语音提醒
        Route::post('about/protocol','IndexsController@voice_play')->name('about.protocol'); // 语音提醒
        Route::post('hotel.decoration','IndexsController@decoration')->name('hotel.decoration'); // 语音提醒
    });
});
?>